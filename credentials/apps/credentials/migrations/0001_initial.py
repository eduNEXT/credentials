    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "course_id",
                    models.CharField(
                        max_length=255, validators=[credentials.apps.credentials.models.validate_course_key]
                    ),
                ),
                (
                    "certificate_type",
                    models.CharField(
                        max_length=255,
                        choices=[("honor", "honor"), ("professional", "professional"), ("verified", "verified")],
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        help_text="Image must be square PNG files. The file size should be under 250KB.",
                        upload_to=credentials.apps.credentials.models.signatory_assets_path,
                        validators=[credentials.apps.credentials.models.validate_image],
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        default="awarded", max_length=255, choices=[("awarded", "awarded"), ("revoked", "revoked")]
                    ),
                ),
                (
                    "download_url",
                    models.CharField(help_text="Download URL for the PDFs.", max_length=255, null=True, blank=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_credential",
                    models.ForeignKey(
                        related_name="attributes", to="credentials.UserCredential", on_delete=models.CASCADE
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True, to="credentials.CertificateTemplate", null=True, on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
